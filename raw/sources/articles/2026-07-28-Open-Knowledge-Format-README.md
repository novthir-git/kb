> **原始链接**：https://github.com/GoogleCloudPlatform/knowledge-catalog/blob/main/okf/README.md
> **抓取日期**：2026-07-28
> **版本**：`main@3fcbb9f828c2f23d109c855ee403c3a4c81f3a96`
> **溯源说明**：OKF README verbatim 存档；包含格式定位、Reference Agent 两阶段流程、样例 Bundle 与 Viewer 实现说明。
> 存入后视为只读存档。
