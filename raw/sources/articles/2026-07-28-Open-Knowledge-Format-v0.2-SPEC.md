> **原始链接**：https://github.com/GoogleCloudPlatform/knowledge-catalog/blob/main/okf/SPEC.md
> **抓取日期**：2026-07-28
> **版本**：`main@3fcbb9f828c2f23d109c855ee403c3a4c81f3a96`
> **溯源说明**：Open Knowledge Format v0.2 规范 verbatim 存档；用于核对 Bundle、Concept、provenance、trust、lifecycle、cross-link、Attested Computation 与 conformance 定义。
> 存入后视为只读存档。
